<div class="modal fade text-left" id="accountinfoedit{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel17">Edit Account Info</h4>
                  ...
                  <div class="row">
                      <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{$row->wallet_no}}" class="form-control" name="wallet_no" placeholder="Enter Wallet No" id="exampleInputEmail1" aria-describedby="emailHelp" required>
